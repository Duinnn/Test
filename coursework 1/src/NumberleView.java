...
public class NumberleView extends JFrame{
    ...
    public JLabel createLabelWithIconAndBounds(ImageIcon icon, int x, int y, int width, int height) {
        JLabel label = new JLabel(icon);
        label.setBounds(x, y, width, height);
        label.addMouseListener(controller.ImageClickListener());
    ...
    // 获取指定颜色的图标
    public ImageIcon getColoredIconForCharacter(char correspondingCharacter, String color) {
